...
# DEV
$ argocd login argocd.20.249.129.204.nip.io --grpc-web

# PRD
$ argocd login argocd.4.230.144.108.nip.io --grpc-web


# [참고] Login to Argo CD using SSO
$ argocd login argocd.20.249.129.204.nip.io --sso

# [참고] Configure direct access using Kubernetes API server
$ argocd login argocd.20.249.129.204.nip.io --core



# logout
$ argocd logout  172.30.1.31:31981
Logged out from '172.30.1.31:31981'
...
$ argocd account update-password \
    --account admin \
    --current-password Z1lfVvu6Tb-9LIwG \
    --new-password New1234! \
    --grpc-web
Password updated
Context 'argocd.20.249.129.204.nip.io' updated
